    ...
    <div className="flex h-screen w-2/3 items-center mx-auto">
      <Container maxWidth="md" className="App">
        <Paper elevation={3} className="rounded-3xl pb-10">
          <img src={TextLogo} alt="Text Logo" width="300" className="mt-5 mx-auto" />
          <div>
          <TextField
            ...
            InputProps={{
              endAdornment: <InputAdornment position="end">
                <InputAdornment position="end">
                  ...
                  >
                    {showPassword ? <Icon className="text-xl" color="secondary">visibility</Icon> : <Icon className="text-xl" color="secondary">visibility_off</Icon>}
                  </IconButton>
                </InputAdornment>
              </InputAdornment>,
            }}
          ...
          <Typography variant="subtitle2">Login with you Youtube</Typography>
